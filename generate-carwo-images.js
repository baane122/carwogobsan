#!/usr/bin/env node
/**
 * CARWO GOBSAN Image Generator - GPT Image API
 * Generates stunning hero and category images
 */
...
const dirs = [
  'public/images/new-hero',
  'public/images/new-categories',
  'public/images/new-featured'
];
...
async function main() {
  console.log('CARWO GOBSAN Image Generator - GPT Image API');
  console.log('=============================================\n');
  ...
  for (let i = 0; i < images.length; i++) {
    ...
    try {
      ...
      console.log(`  SUCCESS: ${img.path} (${(stats.size / 1024).toFixed(1)}KB)`);
    } catch (err) {
